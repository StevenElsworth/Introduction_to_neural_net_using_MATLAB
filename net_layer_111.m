...
S.plot = plot(S.x,S.sigmoid(S.sigmoid(S.x, S.W1, S.b1), S.W2, S.b2));
...
function update(S)
y = S.sigmoid(S.sigmoid(S.x, S.W1, S.b1), S.W2, S.b2);
set(S.plot, 'YData', y);  % Replace old plot with new plotting values
axis([0,1,0,1]);
title(['y = \sigma(', num2str(S.W2), '\sigma(', num2str(S.W1), 'x +', num2str(S.b1), ') + ', num2str(S.b2), ')'], 'FontSize', 30)
end