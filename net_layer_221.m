...
S.sigmoid = @(x1, x2, W1, W2, b) 1./(1+exp(-(W1.*x1' + W2.*x2 + b)));
...
S.plot = imagesc(S.c1*S.sigmoid(S.x1, S.x2, S.W1, S.W2, S.b1) + S.c2*S.sigmoid(S.x1, S.x2, S.W3, S.W4, S.b2));
colorbar
...
S.W4Slider = uicontrol('style','slider',...
               'unit','normalized',...
               'position',[0.6 0.25 0.3 0.01],...
               'min',-30,'max',30,'value', S.W4,...
               'sliderstep',[0.01 0.01],...
               'callback', {@SliderCB, 'W4'}); 
           
txtW4 = uicontrol('Style','text',...
     'unit','normalized',...
...
txtb2 = uicontrol('Style','text',...
     'unit','normalized',...
               'position',[0.6 0.16 0.3 0.05],...
     'String','b2');    
 
S.c1Slider = uicontrol('style','slider',...
               'unit','normalized',...
               'position',[0.1 0.05 0.3 0.01],...
               'min',-0.5,'max',0.5,'value', S.c1,...
               'sliderstep',[0.01 0.01],...
               'callback', {@SliderCB, 'c1'}); 
           
txtc1 = uicontrol('Style','text',...
     'unit','normalized',...
               'position',[0.1 0.06 0.3 0.05],...
     'String','c1');
 
S.c2Slider = uicontrol('style','slide',...
               'unit','normalized',...
               'position',[0.6 0.05 0.3 0.01],...
               'min',-0.5,'max',0.5,'value', S.c2,...
               'sliderstep',[0.01 0.01],...
               'callback', {@SliderCB, 'c2'});

txtc2 = uicontrol('Style','text',...
     'unit','normalized',...
               'position',[0.6 0.06 0.3 0.05],...
     'String','c2');  
...
function update(S)
y = S.c1*S.sigmoid(S.x1, S.x2, S.W1, S.W2, S.b1) + S.c2*S.sigmoid(S.x1, S.x2, S.W3, S.W4, S.b2);
set(S.plot, 'CData', y);  % Replace old plot with new plotting values
axis square
caxis([-1 1])
title(['y = ', num2str(S.c1), ' \sigma(', num2str(S.W1), 'x_1 + ', num2str(S.W2), 'x_2 +', num2str(S.b1), ') + ' , num2str(S.c2), ' \sigma(', num2str(S.W3), 'x_1 + ', num2str(S.W4), 'x_2 +', num2str(S.b2), ')'], 'FontSize', 30)
